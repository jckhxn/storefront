      ...
      <form onSubmit={submitHandler} >
        <ul className="form-container">
          ...
          <li>
            ...
            <input type="text" name="state" id="state" onChange={(e) => setState(e.target.value)}required>
            </input>
          </li>
          <li>
          ...
          <li>
            ...
            <input type="text" name="contact" id="contact" onChange={(e) => setContact(e.target.value)}required>
            </input>
          </li>
